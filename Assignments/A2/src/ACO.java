...
public class ACO {
    ...
    private static final double BETA = 3.0;   // heuristic importance
    ...
    public double run(String instanceName) {
        ...
        for (int i = 0; i < MAX_ITERATIONS; i++) {
            ...
            boolean updated = updateBestSolution(solutions);
            if (updated) {
     ...
     * @param solutions the solutions generated by the ants
     */
    public boolean updateBestSolution(double[][] solutions) {
        double bestValue = 0;
